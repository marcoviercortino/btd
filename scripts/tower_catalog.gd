...
const COSTS := [120, 330, 400, 450, 600, 650, 520, 900]
const NAMES := ["Dardo", "Bumerán", "Bombardero", "Mago", "Arquero místico", "Granja de bananas", "Médica del Arrecife", "Pirata"]
const COLORS := [Color("6cc4ed"), Color("ffcc66"), Color("ef8256"), Color("7aa9ff"), Color("9a7ee8"), Color("ffe164"), Color("62c6a6"), Color("d99055")]
...
static func config(kind: int) -> Dictionary:
	var configs := [
		...
		{"range": 90.0, "damage": 2, "reload": 1.75, "projectile_speed": 0.0, "projectile_range": 0.0}
	]
	return configs[kind]
